...
browser.findElement({ xpath:'/html/body/div/div[2]/div[2]/div[4]/button'}).click();
sleepTime("Нажимаем на кнопку Edit",2000);

//Получаем текст из инпута
browser.findElement({ xpath:'/html/body/div/div[2]/div[2]/div[2]/div/form/input'}).getAttribute("value").
                then(function(text) {
                  console.log('result: ', text);
//                  done();

                    browser.findElement({ xpath:'/html/body/div/div[2]/div[2]/div[2]/div/form/input'}).sendKeys(webdriver.Key.CONTROL, "a");
                    sleepTime("Key.CONTROL.a",5000);

                    browser.findElement({ xpath:'/html/body/div/div[2]/div[2]/div[2]/div/form/input'}).clear();
                    sleepTime("clear",2000);
                        
                    browser.findElement({ xpath:'/html/body/div/div[2]/div[2]/div[2]/div/form/input'}).sendKeys(text + " тест");
                    ...
                    browser.findElement({ xpath:'/html/body/div/div[2]/div[2]/div[2]/div/form/input'}).sendKeys(webdriver.Key.ENTER);
                    ...
                    browser.findElement({ xpath:'/html/body/div/div[2]/div[2]/div[2]/div/form/input'}).sendKeys(text);
