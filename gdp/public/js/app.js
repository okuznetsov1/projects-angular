(function(){
    ...
    var app = angular
            .module('notes', ['lumx', 'lumx.data-table', 'lumx.dialog', 'googlechart', 'ngSanitize', 'FredrikSandell.worker-pool'])
    ...
    app.controller('MainController', ['$filter', '$scope', 'WorkerService', 'LxNotificationService', 'LxDialogService', '$http', '$log', function($filter, $scope, WorkerService, LxNotificationService, LxDialogService, $http, $log) {
        ...
        $scope.InsertTextFromFile = function(content){
            ...
            angular.forEach(content, function (value, key) {
                ...
                angular.forEach(value, function (element, index) {
                    ...
                    if(key !== 0){
                        dataTableTbody += $scope.dataTableThead[index].name + ': ' + isInt(element) + ', ';
                    }
                });
                if(key !== 0){
        ...
        function openDialogCharts(){
            ...
            angular.forEach($scope.selectedRows, function (element, index) {
            ...
            LxDialogService.open($scope.dialogIdCharts);
